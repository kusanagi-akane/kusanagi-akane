...
- 18 歲的全端開發者，熱愛寫程式，目前就讀國立東華大學。
- 開發並維護大型多功能 Discord 機器人，主打專案「貓貓超可愛」已突破 **35 萬** 使用者。
...
| 專案名稱 | 說明 | 連結 |
| --- | --- | --- |
| **貓貓超可愛機器人** | 擁有 **35 萬+ 使用者**的大型多功能 Discord Bot，包含虛擬股市、抽卡系統、AI 繪圖與社群管理功能。 | [官網](https://cathome.shop/bot) |
...
- Website：[cathome.shop/kusanagi-akane](https://cathome.shop/kusanagi-akane/)
